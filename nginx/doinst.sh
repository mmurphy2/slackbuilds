...
if ! id nginx >/dev/null 2>&1; then
    echo "To use nginx, you will need to create a user and group for it:"
    echo "groupadd -g 207 nginx"
    echo "useradd -u 207 -d /var/lib/nginx -s /bin/false -g nginx nginx"
fi
